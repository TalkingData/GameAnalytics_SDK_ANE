package com.talkingdata.game.util
{
	public class GameFunctionType
	{
		...
		public static var ChargeSuccess:int =51;
		public static var OnReward:int=52;
		
		
		public static var ItemPurchse:int=60;
		public static var ItemUse:int=61;
		
		public static var MissionBegin:int=70;
		public static var MissionCompleted:int=71;
		public static var MissionFailed:int=72;
		
		public static var CusEvent:int=80;
		
		public static var GetDeviceID:int=1;
		public static var isOpenDebugLog:int=2;
		public static var setlocation:int=3;
