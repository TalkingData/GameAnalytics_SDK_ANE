...
public class TDFunctionType {
	...
	public final static int ChargeSuccess =51;
	public final static int Onreward=52;
	
	
	public final static int ItemPurchse=60;
	public final static int ItemUse=61;
	
	public final static int MissionBegin=70;
	public final static int MissionCompleted=71;
